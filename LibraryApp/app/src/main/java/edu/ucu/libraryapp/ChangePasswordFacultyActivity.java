...
public class ChangePasswordFacultyActivity extends AppCompatActivity {
    ...
    private boolean validatePassword(){
        ...
        String studentNo = loginSharedPrefManager.getFacultyNo();
    ...
    private void showDialog(){
        loadingDialog = new Dialog(ChangePasswordFacultyActivity.this);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try{
                            ...
                            if(result.equals("1")){
                                AppUtils.toastMessage(ChangePasswordFacultyActivity.this,"Update password successful");
                                finish();
                            }
